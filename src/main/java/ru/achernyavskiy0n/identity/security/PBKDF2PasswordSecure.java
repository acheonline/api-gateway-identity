...
@Component
public class PBKDF2PasswordSecure implements PasswordSecure {

  @Override
  public String encrypt(String password) throws PasswordSecureException {
    try {
      ...
      throw new PasswordSecureException(e);
    }
  }
  ...
  public boolean validate(String password, String encryptedPassword)
      throws PasswordSecureException {
    try {
